...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data();
        ExpLAdapter adapter =  new ExpLAdapter(this, groupData, childData);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                String childText = Objects.requireNonNull(childData.get(groupData.get(groupPosition))).get(childPosition);
    ...
    private void data() {
        String[] headerString = getResources().getStringArray(R.array.food_array);
        String[] childString = getResources().getStringArray(R.array.food_array_subtitle);
